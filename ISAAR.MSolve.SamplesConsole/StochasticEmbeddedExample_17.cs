...
{
    public static class StochasticEmbeddedExample_17
    {
        public static class Run1_2a_Elastic
        {
            ...
            {
                const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run1-2a\output files\elastic\DisplacementControl";
            ...
            public static class EBEEmbeddedModelBuilder
            {
                ...
                {
                    string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run1-2a\input files";
        ...
        public static class Run1_2a_Plastic
        {
            ...
            public static void PEEKMatrix_DisplacementControl(int noStochasticSimulation)
            {
                const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run1-2a\output files\plastic\DisplacementControl";
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-3a\input files";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 17\run-3a\input files";
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-3a\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-3a\output files\elastic";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 17\run-3a\output files\elastic"; 
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-3a\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 3350;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-3a\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-3a\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 3350;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-3b\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-3b\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 3350;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-3b\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-3b\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 3350;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-3c\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-3c\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 3350;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-3c\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-3c\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 3350;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-3d\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-3d\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 3350;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-3d\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-3d\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 3350;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-4a\input files";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 17\run-3a\input files";
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-3a\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-4a\output files\elastic";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 17\run-3a\output files\elastic"; 
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-3a\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-4a\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-4a\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 3350;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-4b\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-4b\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 3350;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-4b\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-4b\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 3350;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-4c\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-4c\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 3350;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-4c\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 17\run-4c\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 3350;
