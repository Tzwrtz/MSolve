...
{
    public static class StochasticEmbeddedExample_21
    {
        public static class Run1_2a_Elastic
        {
            ...
            {
                const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run1-2a\output files\elastic\DisplacementControl";
                ...
                // Boundary Conditions - [Left-End]: (z = 0.0)
                ...
                // Boundary Conditions - [Bottom-End]: (y = 0.0)
                ...
                // Boundary Conditions - [Back-End]: (x = 0.0)
                for (int iNode = 1; iNode <= 4081; iNode += +16)
                {
                    model.NodesDictionary[iNode].Constraints.Add(new Constraint { DOF = DOFType.X });
                }

                // Loading Conditions - [Right-End] : (z = 100.0) - {256 nodes}
            ...
            public static class EBEEmbeddedModelBuilder
            {
                ...
                {
                    string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run1-2a\input files";
        ...
        public static class Run1_2a_Plastic
        {
            ...
            public static void PEEKMatrix_DisplacementControl(int noStochasticSimulation)
            {
                const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run1-2a\output files\plastic\DisplacementControl";
                ...
                // Choose model
                EBEEmbeddedModelBuilder.PlasticPEEKMatrixBuilder(model);
            ...
            public static class EBEEmbeddedModelBuilder
            {
                public static void PlasticPEEKMatrixBuilder(Model_v2 model)
                {
                    HostElements(model);
                }
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-2a\input files";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 21\run-2a\input files";
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-2a\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-2a\output files\elastic";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 21\run-2a\output files\elastic"; 
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-2a\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 3375;
            private const int hostNodes = 4096;
            private const int embeddedElements = 6350;
            private const int embeddedNodes = 7620;
            private const double nodalDisplacement = -10.0;
            private const int monitorNode = 3841;
            private const DOFType monitorDof = DOFType.Z;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-2a\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-2a\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 3375;
            private const int hostNodes = 4096;
            private const int embeddedElements = 6350;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-2a\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-2b\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 3375;
            private const int hostNodes = 4096;
            private const int embeddedElements = 6350;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-2a\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-2b\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 3375;
            private const int hostNodes = 4096;
            private const int embeddedElements = 6350;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-2a\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-2c\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 3375;
            private const int hostNodes = 4096;
            private const int embeddedElements = 6350;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-2a\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-2c\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 3375;
            private const int hostNodes = 4096;
            private const int embeddedElements = 6350;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-2d\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-2d\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 3375;
            private const int hostNodes = 4096;
            private const int embeddedElements = 6350;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-2d\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-2d\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 3375;
            private const int hostNodes = 4096;
            private const int embeddedElements = 6350;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-3a\input files";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 21\run-3a\input files";
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-3a\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-3a\output files\elastic";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 21\run-3a\output files\elastic"; 
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-3a\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 3375;
            private const int hostNodes = 4096;
            private const int embeddedElements = 6350;
            ...
            // Cohesive Zone mechanical properties
            private const double t_max = 0.05;
            private const double K_coh = 50.0;
            ...
            public static void SingleMatrix_DisplacementControl()
            {
                ...
                // Request output
                string currentOutputFileName = "Run3a-SingleMatrix-Elastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, "000");
            ...
            public static void EBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run3a-FullyBonded-Elastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, noStochasticSimulation);
            ...
            public static void CohesiveEBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run3a-Cohesive-Elastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, noStochasticSimulation);
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-3a\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-3a\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 3375;
            private const int hostNodes = 4096;
            private const int embeddedElements = 6350;
            ...
            public static void SingleMatrix_DisplacementControl()
            {
                ...
                // Request output
                string currentOutputFileName = "Run3a-SingleMatrix-Plastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, "000");
            ...
            public static void EBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run3a-FullyBonded-Plastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, noStochasticSimulation);
            ...
            public static void CohesiveEBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run3a-Cohesive-Plastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, noStochasticSimulation);
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-3b\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-3b\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 3375;
            private const int hostNodes = 4096;
            private const int embeddedElements = 6350;
            ...
            public static void EBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run3b-FullyBonded-Elastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, noStochasticSimulation);
            ...
            public static void CohesiveEBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run3b-Cohesive-Elastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, noStochasticSimulation);
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-3b\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-3b\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 3375;
            private const int hostNodes = 4096;
            private const int embeddedElements = 6350;
            ...
            public static void EBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run3b-FullyBonded-Plastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, noStochasticSimulation);
            ...
            public static void CohesiveEBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run3b-Cohesive-Plastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string outputFile = string.Format("{0}_{1}{2}", fileNameOnly, noStochasticSimulation, extension);
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-3c\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-3c\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 3375;
            private const int hostNodes = 4096;
            private const int embeddedElements = 6350;
            ...
            public static void EBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run3c-FullyBonded-Elastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string outputFile = string.Format("{0}_{1}{2}", fileNameOnly, noStochasticSimulation, extension);
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-3c\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-3c\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 3375;
            private const int hostNodes = 4096;
            private const int embeddedElements = 6350;
            ...
            public static void EBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run3c-FullyBonded-Plastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string outputFile = string.Format("{0}_{1}{2}", fileNameOnly, noStochasticSimulation, extension);
            ...
            public static void CohesiveEBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run3c-Cohesive-Plastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, noStochasticSimulation);
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-3d\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-3d\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 3375;
            private const int hostNodes = 4096;
            private const int embeddedElements = 6350;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-3d\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-3d\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 3375;
            private const int hostNodes = 4096;
            private const int embeddedElements = 6350;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-4a\input files";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 21\run-3a\input files";
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-3a\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-4a\output files\elastic";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 21\run-3a\output files\elastic"; 
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-3a\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 3375;
            ...
            public static void SingleMatrix_DisplacementControl()
            {
                ...
                // Request output
                string currentOutputFileName = "Run4a-SingleMatrix-Elastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, "000");
            ...
            public static void EBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run4a-FullyBonded-Elastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, noStochasticSimulation);
            ...
            public static void CohesiveEBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run4a-Cohesive-Elastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, noStochasticSimulation);
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-4a\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-4a\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 3375;
            private const int hostNodes = 4096;
            private const int embeddedElements = 6350;
            ...
            public static void SingleMatrix_DisplacementControl()
            {
                ...
                // Request output
                string currentOutputFileName = "Run4a-SingleMatrix-Plastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, "000");
            ...
            public static void EBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run4a-FullyBonded-Plastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, noStochasticSimulation);
            ...
            public static void CohesiveEBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run4a-Cohesive-Plastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, noStochasticSimulation);
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-4b\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-4b\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 3375;
            private const int hostNodes = 4096;
            private const int embeddedElements = 6350;
            ...
            public static void EBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run4b-FullyBonded-Elastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, noStochasticSimulation);
            ...
            public static void CohesiveEBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run4b-Cohesive-Elastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, noStochasticSimulation);
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-4b\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-4b\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 3375;
            private const int hostNodes = 4096;
            private const int embeddedElements = 6350;
            ...
            public static void EBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run4b-FullyBonded-Plastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, noStochasticSimulation);
            ...
            public static void CohesiveEBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run4b-Cohesive-Plastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string outputFile = string.Format("{0}_{1}{2}", fileNameOnly, noStochasticSimulation, extension);
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-4c\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-4c\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 3375;
            private const int hostNodes = 4096;
            private const int embeddedElements = 6350;
            ...
            public static void EBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run4c-FullyBonded-Elastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string outputFile = string.Format("{0}_{1}{2}", fileNameOnly, noStochasticSimulation, extension);
            ...
            public static void CohesiveEBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run4c-Cohesive-Elastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, noStochasticSimulation);
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-4c\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-4c\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 3375;
            private const int hostNodes = 4096;
            private const int embeddedElements = 6350;
            ...
            public static void EBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run4c-FullyBonded-Plastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string outputFile = string.Format("{0}_{1}{2}", fileNameOnly, noStochasticSimulation, extension);
            ...
            public static void CohesiveEBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run4c-Cohesive-Plastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, noStochasticSimulation);
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-4d\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 21\run-4d\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 3375;
            private const int hostNodes = 4096;
            private const int embeddedElements = 6350;
            ...
            public static void EBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run4d-FullyBonded-Elastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string outputFile = string.Format("{0}_{1}{2}", fileNameOnly, noStochasticSimulation, extension);
            ...
            public static void CohesiveEBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run4d-Cohesive-Elastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, noStochasticSimulation);
        ...
        public static class Run4d_Plastic
        {
            ...
            public static void EBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run4d-FullyBonded-Plastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string outputFile = string.Format("{0}_{1}{2}", fileNameOnly, noStochasticSimulation, extension);
            ...
            public static void CohesiveEBEembeddedInMatrix_DisplacementControl(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run4d-Cohesive-Plastic.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, noStochasticSimulation);
