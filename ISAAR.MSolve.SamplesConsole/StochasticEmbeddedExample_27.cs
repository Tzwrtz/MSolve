...
{
    public static class StochasticEmbeddedExample_27
    {
        //Run_2

        public static class Run2a_Elastic
        {
            private const string workingDirectory = @"C:\Users\cluster\source\repos\gsoim\Stochastic Embedded Example 27\run-2a\input files";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 27\run-2a\input files";
            //"C:\Users\cluster\source\repos\gsoim\Stochastic Embedded Example 27\run-2a\input files";
            private const string outputDirectory = @"C:\Users\cluster\source\repos\gsoim\Stochastic Embedded Example 27\run-2a\output files\elastic";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 27\run-2a\output files\elastic"; 
            //"C:\Users\cluster\source\repos\gsoim\Stochastic Embedded Example 27\run-2a\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 125;
            private const int hostNodes = 216;
            private const int embeddedElements = 240;
            private const int embeddedNodes = 288;
            ...
            public static class EBEEmbeddedModelBuilder
            {
                ...
                private static void HostElements(Model_v2 model)
                {
                    ...
                    string MatrixConnectivityFileName = "MATRIX_3D-L_x=50-L_y=50-L_z=50-5x5x5-ConnMatr_MSolve.inp";
        ...
        public static class Run2a_Plastic
        {
            ...
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 27\run-2a\input files";
            //"C:\Users\cluster\source\repos\gsoim\Stochastic Embedded Example 27\run-2a\input files";
            private const string outputDirectory = @"C:\Users\cluster\source\repos\gsoim\Stochastic Embedded Example 27\run-2a\output files\plastic";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 27\run-2a\output files\plastic"; 
            //"C:\Users\cluster\source\repos\gsoim\Stochastic Embedded Example 27\run-2a\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 125;
            private const int hostNodes = 216;
            private const int embeddedElements = 240;
