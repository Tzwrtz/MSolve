...
{
    public static class StochasticEmbeddedExample_18
    {
        //Run_2

        public static class Run2a_Elastic
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\input files";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\input files";
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\output files\elastic";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\output files\elastic"; 
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\output files\elastic";
            ...
            private const int monitorNode = 11;
            private const DOFType monitorDof = DOFType.X;
            private const int increments = 10;

            // Cohesive Zone mechanical properties
            private const double t_max = 0.5;
            ...
            public static void SingleMatrix_DisplacementControl()
            {
                ...
                for (int iNode = 1; iNode <= 22; iNode++)
                {
                    model.NodesDictionary[iNode].Constraints.Add(new Constraint { DOF = DOFType.Z });
                }

                // Loading Conditions - [Right-End] - {4 nodes}
                for (int iNode = 11; iNode <= 44; iNode += 11)
                {
            ...
            public static class EBEEmbeddedModelBuilder
            {
                ...
                public static void FullyBondedEmbeddedBuilder_Stochastic(Model_v2 model, int i)
                {
                    ...
                    //var embeddedGrouping = EmbeddedBeam3DGrouping.CreateFullyBonded(model, model.ElementsDictionary.Where(x => x.Key <= hostElements).Select(kv => kv.Value), model.ElementsDictionary.Where(x => x.Key > hostElements).Select(kv => kv.Value), false);
                }
                ...
                public static void CohesiveEmbeddedBuilder_Stochastic(Model_v2 model, int i)
                {
                    ...
                    //var embeddedGrouping = EmbeddedBeam3DGrouping.CreateCohesive(model, model.ElementsDictionary.Where(x => x.Key <= hostElements).Select(kv => kv.Value), model.ElementsDictionary.Where(x => x.Key > hostElements).Select(kv => kv.Value), true);
                }

                private static void HostElements(Model_v2 model)
                {
                    string MatrixGeometryFileName = "MATRIX_3D-L_x=100-L_y=10-L_z=7-10x1x1-Geometry_MSolve.inp";
                    string MatrixGonnectivityFileName = "MATRIX_3D-L_x=100-L_y=10-L_z=7-10x1x1-ConnMatr_MSolve.inp";
        ...
        {
            private const string workingDirectory = @"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\input files";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\input files";
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\input files";
            private const string outputDirectory = @"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\output files\plastic";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\output files\elastic";
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 10;
            private const int hostNodes = 44;
            private const int embeddedElements = 10;
        ...
        {
            private const string workingDirectory = @"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-2b\input files";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\input files";
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\input files";
            private const string outputDirectory = @"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-2b\output files\elastic";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\output files\elastic";
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 10;
            ...
            // Cohesive Zone mechanical properties
            private const double t_max = 1.0;
            private const double K_coh = 10.0;
        ...
        public static class Run2b_Plastic
        {
            ...
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\input files";
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\input files";
            private const string outputDirectory = @"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-2b\output files\plastic";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\output files\elastic";
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 10;
        ...
        {
            private const string workingDirectory = @"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-2c\input files";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\input files";
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\input files";
            private const string outputDirectory = @"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-2c\output files\elastic";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\output files\elastic";
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 10;
            ...
            // Cohesive Zone mechanical properties
            private const double t_max = 2.0;
            private const double K_coh = 10.0;
        ...
        public static class Run2c_Plastic
        {
            ...
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\input files";
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\input files";
            private const string outputDirectory = @"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-2c\output files\plastic";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\output files\elastic";
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-2a\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 10;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-3a\input files";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-3a\input files";
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-3a\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-3a\output files\elastic";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-3a\output files\elastic"; 
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-3a\output files\elastic";
            private const int subdomainID = 0;
        ...
        public static class Run3a_Plastic
        {
            ...
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-3a\input files";
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-3a\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-3a\output files\plastic";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-3a\output files\elastic"; 
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-3a\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 2;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-3b\input files";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-3a\input files";
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-3a\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-3b\output files\elastic";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-3a\output files\elastic"; 
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-3a\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 2;
        ...
        public static class Run3b_Plastic
        {
            ...
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-3a\input files";
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-3a\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-3b\output files\plastic";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-3a\output files\elastic"; 
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-3a\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 2;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-3c\input files";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-3a\input files";
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-3a\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-3c\output files\elastic";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-3a\output files\elastic"; 
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-3a\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 2;
        ...
        {
            private const string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-3c\input files";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-3c\input files";
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-3c\input files";
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-3c\output files\plastic";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 18\run-3c\output files\elastic"; 
            //"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 18\run-3c\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 2;
            private const int hostNodes = 12;
            private const int embeddedElements = 10;
