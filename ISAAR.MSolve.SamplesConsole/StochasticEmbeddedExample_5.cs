...
{
    public class StochasticEmbeddedExample_5
    {
        public static class Run2a_Elastic
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 5\run-2a\output files\elastic";
            ...
            private const double nodalLoad = -100.0; // +1000.0;//
            private const int monitorNode = 41;
            ...
            public static void SingleMatrix_NewtonRaphson_Stochastic(int noStochasticSimulation)
            {
                ...
                for (int iNode = 3; iNode <= 43; iNode += 4)
                {
                    for (int j = 0; j <= 1; j++)
                    {
                        model.NodesDictionary[iNode + j].Constraints.Add(new Constraint { DOF = DOFType.Y });
                ...
                for (int iNode = 41; iNode <= 44; iNode++)
                {
            ...
            {                
                ...
                {
                    string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 5\run-2a\input files";
                    string MatrixGeometryFileName = "MATRIX_3D-L_x=10-L_y=11-L_z=100-1x1x10-Geometry_MSolve.inp";
                    string MatrixConnectivityFileName = "MATRIX_3D-L_x=10-L_y=11-L_z=100-1x1x10-ConnMatr_MSolve.inp";
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 5\run-2a\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 10;
            private const int hostNodes = 44;
            private const int embeddedElements = 10;
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 5\run-2b\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 80;
            private const int hostNodes = 189;
            private const int embeddedElements = 10;
            private const int embeddedNodes = 11;
            private const double nodalLoad = -44.444;
            ...
            public static void SingleMatrix_NewtonRaphson_Stochastic(int noStochasticSimulation)
            {
                ...
                // Boundary Conditions - [Bottom-End]
                for (int iNode = 1; iNode <= 181; iNode += 9)
                {
                    for (int j = 0; j <= 2; j++)
                    {
                        model.NodesDictionary[iNode + j].Constraints.Add(new Constraint { DOF = DOFType.Y });
                ...
                // Boundary Conditions - [Top-End]
                for (int iNode = 7; iNode <= 187; iNode += 9)
                {
                    for (int j = 0; j <= 2; j++)
                    {
                        model.NodesDictionary[iNode + j].Constraints.Add(new Constraint { DOF = DOFType.Y });
                ...
                // Boundary Conditions - [Front-End]
                for (int iNode = 1; iNode <= 187; iNode += 3)
                {
                    model.NodesDictionary[iNode].Constraints.Add(new Constraint { DOF = DOFType.X });
                }

                // Boundary Conditions - [Back-End]
                for (int iNode = 3; iNode <= 189; iNode += 3)
                {
                    model.NodesDictionary[iNode].Constraints.Add(new Constraint { DOF = DOFType.X });
                }

                // Loading Conditions - [Right-End] - {4 nodes}
                for (int iNode = 181; iNode <= 189; iNode++)
                {
                    model.Loads.Add(new Load_v2() { Amount = nodalLoad, Node = model.NodesDictionary[iNode], DOF = DOFType.Z });
                }
            ...
            public static class EBEEmbeddedModelBuilder
            {
                ...
                private static void HostElements(Model_v2 model)
                {
                    string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 5\run-2b\input files";
                    string MatrixGeometryFileName = "MATRIX_3D-L_x=10-L_y=11-L_z=100-2x2x20-Geometry_MSolve.inp";
                    string MatrixConnectivityFileName = "MATRIX_3D-L_x=10-L_y=11-L_z=100-2x2x20-ConnMatr_MSolve.inp";
                    int matrixNodes = File.ReadLines(workingDirectory + '\\' + MatrixGeometryFileName).Count();
                    int matrixElements = File.ReadLines(workingDirectory + '\\' + MatrixConnectivityFileName).Count();
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 5\run-2b\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 80;
            private const int hostNodes = 189;
            private const int embeddedElements = 10;
