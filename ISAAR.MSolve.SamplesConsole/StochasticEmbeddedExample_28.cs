...
{
    public static class StochasticEmbeddedExample_28
    {
        //Run_2

        public static class Run2a_Elastic
        {
            private const string workingDirectory = @"C:\Users\cluster\source\repos\gsoim\Stochastic Embedded Example 28\run-2a\input files";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 28\run-2a\input files";
            //"C:\Users\cluster\source\repos\gsoim\Stochastic Embedded Example 28\run-2a\input files";
            private const string outputDirectory = @"C:\Users\cluster\source\repos\gsoim\Stochastic Embedded Example 28\run-2a\output files\elastic";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 28\run-2a\output files\elastic"; 
            //"C:\Users\cluster\source\repos\gsoim\Stochastic Embedded Example 28\run-2a\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 7700;
            private const int embeddedNodes = 8470;
            private const double nodalDisplacement = -20.0;
            ...
            public static class EBEEmbeddedModelBuilder
            {
                ...
                private static void HostElements(Model_v2 model)
                {
                    ...
                    string MatrixConnectivityFileName = "MATRIX_3D-L_x=200-L_y=200-L_z=200-10x10x10-ConnMatr_MSolve.inp";
        ...
        public static class Run2a_Plastic
        {
            ...
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 28\run-2a\input files";
            //"C:\Users\cluster\source\repos\gsoim\Stochastic Embedded Example 28\run-2a\input files";
            private const string outputDirectory = @"C:\Users\cluster\source\repos\gsoim\Stochastic Embedded Example 28\run-2a\output files\plastic";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 28\run-2a\output files\plastic"; 
            //"C:\Users\cluster\source\repos\gsoim\Stochastic Embedded Example 28\run-2a\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 7700;
