...
namespace ISAAR.MSolve.SamplesConsole
{
    ...
    {
        public static class Jerry_Example_Elastic
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 10\Jerry-Example\output files\elastic"; //"C:\Users\tzwrt\Desktop\output files\EmbeddedExample_10"; //
            ...
            public static void Jerry_SingleMatrix(int noStochasticSimulation)
            {
                ...
                // Imposed Displacements - [Right-End] - {4 nodes}
                model.NodesDictionary[1].Constraints.Add(new Constraint { DOF = DOFType.Y, Amount = 12.5 });
                model.NodesDictionary[2].Constraints.Add(new Constraint { DOF = DOFType.Y, Amount = 12.5 });
                model.NodesDictionary[1].Constraints.Add(new Constraint { DOF = DOFType.Z, Amount = 1.65 });
                model.NodesDictionary[2].Constraints.Add(new Constraint { DOF = DOFType.Z, Amount = 1.65 });

                model.NodesDictionary[3].Constraints.Add(new Constraint { DOF = DOFType.Y, Amount = 13.84 });
                model.NodesDictionary[4].Constraints.Add(new Constraint { DOF = DOFType.Y, Amount = 13.84 });
                model.NodesDictionary[3].Constraints.Add(new Constraint { DOF = DOFType.Z, Amount = 6.65 });
                model.NodesDictionary[4].Constraints.Add(new Constraint { DOF = DOFType.Z, Amount = 6.65 });
                ...
                // Request output
                string currentOutputFileName = "Jerry-SingleMatrix-Results_DC.txt";
            ...
            public static void Jerry_Embedded(int noStochasticSimulation)
            {
                VectorExtensions.AssignTotalAffinityCount();
                ...
                // Request output
                string currentOutputFileName = "Jerry-Embedded-Results_DC.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, noStochasticSimulation);
            ...
            public static void Jerry_Cohesive(int noStochasticSimulation)
            {
                VectorExtensions.AssignTotalAffinityCount();
                ...
                // Request output
                string currentOutputFileName = "Jerry-Cohesive-Results_DC.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, noStochasticSimulation);
            ...
            public static class EBEEmbeddedModelBuilder
            {
                ...
                {
                    string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 10\Jerry-Example\input files"; //"C:\Users\tzwrt\Desktop\input files"; //
                ...
                private static void CohesiveBeamElements_Stochastic(Model_v2 model, int noStochasticSimulation)
                {
                    ...
                    double poissonRatio = (youngModulus / (2 * shearModulus)) - 1; // 2.15; // 0.034; //
                    double area = 1776.65;  // CNT(20,20)-LinearEBE-TBT-L = 10nm
                    double radius_CNT = 1.50;
                    double constant_value = 2.0 * Math.PI * radius_CNT;
                    double inertiaY = 1058.55;
                    double inertiaZ = 1058.55;
                    double torsionalInertia = 496.38;
                    double effectiveAreaY = area;
                    ...
                    var cohesiveMaterial = new BondSlipCohMatUniaxial((10.0 * constant_value), (1.0 * constant_value), 1000000.0, 0.05, new double[2], new double[2], 1e-3);
        ...
        public static class Run2a_Elastic
        {
            ...
            public static void Jerry_Cohesive_Example_DisplacementControl_Stochastic(int noStochasticSimulation)
            {
                VectorExtensions.AssignTotalAffinityCount();
                ...
                // Imposed Displacements - [Right-End] - {4 nodes}
                model.NodesDictionary[1].Constraints.Add(new Constraint { DOF = DOFType.Y, Amount = 5.0 });
                model.NodesDictionary[2].Constraints.Add(new Constraint { DOF = DOFType.Y, Amount = 5.0 });
                model.NodesDictionary[1].Constraints.Add(new Constraint { DOF = DOFType.Z, Amount = 2.0 });
                model.NodesDictionary[2].Constraints.Add(new Constraint { DOF = DOFType.Z, Amount = 2.0 });

                model.NodesDictionary[3].Constraints.Add(new Constraint { DOF = DOFType.Y, Amount = 10.0 });
                model.NodesDictionary[4].Constraints.Add(new Constraint { DOF = DOFType.Y, Amount = 10.0 });
                model.NodesDictionary[3].Constraints.Add(new Constraint { DOF = DOFType.Z, Amount = 5.0 });
                model.NodesDictionary[4].Constraints.Add(new Constraint { DOF = DOFType.Z, Amount = 5.0 });
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 10\run-2b\output files\elastic";
            private const int subdomainID = 0;
            ...
            public static void SingleMatrix_DisplacementControl_Stochastic(int noStochasticSimulation)
            {
                ...
                //model.NodesDictionary[10].Constraints.Add(new Constraint { DOF = DOFType.Y });
                //model.NodesDictionary[11].Constraints.Add(new Constraint { DOF = DOFType.Y });
                //model.NodesDictionary[12].Constraints.Add(new Constraint { DOF = DOFType.Y });

                // Displacement Control Conditions - [Right-End]
                for (int iNode = 3; iNode <= 12; iNode = iNode + 3)
                {
                ...
                // Request output
                string currentOutputFileName = "Run2b-SingleMatrix-Elastic-Results_DC.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, noStochasticSimulation);
            ...
            public static void EBEembeddedInMatrix_DisplacementControl_Stochastic(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run2b-FullyBonded-Elastic-Results_DC.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, noStochasticSimulation);
            ...
            public static void EBEembeddedInMatrixCohesive_DisplacementControl_Stochastic(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run2b-Cohesive-Elastic-Results_DC.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string paraviewFileName = string.Format("{0}_{1}", fileNameOnly, noStochasticSimulation);
            ...
            public static class EBEEmbeddedModelBuilder
            {
                ...
                private static void HostElements(Model_v2 model)
                {
                    string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 10\run-2b\input files";
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 10\run-2b\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 2;
            private const int hostNodes = 12;
            private const int embeddedElements = 1;
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 10\run-2c\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 2;
            private const int hostNodes = 12;
            ...
            public static class EBEEmbeddedModelBuilder
            {
                ...
                private static void HostElements(Model_v2 model)
                {
                    string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 10\run-2c\input files";
                    string MatrixGeometryFileName = "MATRIX_3D-L_x=20-L_y=10-L_z=10-2x1x1-Geometry_MSolve.inp";
                    string MatrixConnectivityFileName = "MATRIX_3D-L_x=20-L_y=10-L_z=10-2x1x1-ConnMatr_MSolve.inp";
                    int matrixNodes = File.ReadLines(workingDirectory + '\\' + MatrixGeometryFileName).Count();
                    int matrixElements = File.ReadLines(workingDirectory + '\\' + MatrixConnectivityFileName).Count();
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 10\run-2c\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 2;
            private const int hostNodes = 12;
            private const int embeddedElements = 2;
