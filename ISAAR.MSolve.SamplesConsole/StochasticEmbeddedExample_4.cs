...
{
    public static class StochasticEmbeddedExample_4
    {
        public static class Run2a_Elastic
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-2a\output files\elastic";
            ...
            public static class EBEEmbeddedModelBuilder
            {
                ...
                {
                    string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-2a\input files";
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-2a\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 2000;
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-2b\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 2000;
            ...
            public static class EBEEmbeddedModelBuilder
            {
                ...
                private static void HostElements(Model_v2 model)
                {
                    string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-2b\input files";
                    string MatrixGeometryFileName = "MATRIX_3D-L_x=200-L_y=200-L_z=200-10x10x10-Geometry_MSolve.inp";
                    string MatrixGonnectivityFileName = "MATRIX_3D-L_x=200-L_y=200-L_z=200-10x10x10-ConnMatr_MSolve.inp";
                    int matrixNodes = File.ReadLines(workingDirectory + '\\' + MatrixGeometryFileName).Count();
                    int matrixElements = File.ReadLines(workingDirectory + '\\' + MatrixGonnectivityFileName).Count();
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-2b\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 2000;
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-2c\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 2000;
            ...
            public static class EBEEmbeddedModelBuilder
            {
                ...
                private static void HostElements(Model_v2 model)
                {
                    string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-2c\input files";
                    string MatrixGeometryFileName = "MATRIX_3D-L_x=200-L_y=200-L_z=200-10x10x10-Geometry_MSolve.inp";
                    string MatrixGonnectivityFileName = "MATRIX_3D-L_x=200-L_y=200-L_z=200-10x10x10-ConnMatr_MSolve.inp";
                    int matrixNodes = File.ReadLines(workingDirectory + '\\' + MatrixGeometryFileName).Count();
                    int matrixElements = File.ReadLines(workingDirectory + '\\' + MatrixGonnectivityFileName).Count();
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-2c\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 2000;
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-2d\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 2000;
            ...
            public static class EBEEmbeddedModelBuilder
            {
                ...
                private static void HostElements(Model_v2 model)
                {
                    string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-2d\input files";
                    string MatrixGeometryFileName = "MATRIX_3D-L_x=200-L_y=200-L_z=200-10x10x10-Geometry_MSolve.inp";
                    string MatrixGonnectivityFileName = "MATRIX_3D-L_x=200-L_y=200-L_z=200-10x10x10-ConnMatr_MSolve.inp";
                    int matrixNodes = File.ReadLines(workingDirectory + '\\' + MatrixGeometryFileName).Count();
                    int matrixElements = File.ReadLines(workingDirectory + '\\' + MatrixGonnectivityFileName).Count();
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-2d\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 2000;
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-3a\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 7000;
            private const int embeddedNodes = 7700;
            ...
            public static class EBEEmbeddedModelBuilder
            {
                ...
                private static void HostElements(Model_v2 model)
                {
                    string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-3a\input files";
                    string MatrixGeometryFileName = "MATRIX_3D-L_x=200-L_y=200-L_z=200-10x10x10-Geometry_MSolve.inp";
                    string MatrixGonnectivityFileName = "MATRIX_3D-L_x=200-L_y=200-L_z=200-10x10x10-ConnMatr_MSolve.inp";
                    int matrixNodes = File.ReadLines(workingDirectory + '\\' + MatrixGeometryFileName).Count();
                    int matrixElements = File.ReadLines(workingDirectory + '\\' + MatrixGonnectivityFileName).Count();
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-3a\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 7000;
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-3b\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 7000;
            ...
            public static void EBEembeddedInMatrix_NewtonRaphson_Stochastic(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run3b-Stochastic-CNT-Results.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string outputFile = string.Format("{0}_{1}{2}", fileNameOnly, noStochasticSimulation, extension);
            ...
            public static class EBEEmbeddedModelBuilder
            {
                ...
                private static void HostElements(Model_v2 model)
                {
                    string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-3b\input files";
                    string MatrixGeometryFileName = "MATRIX_3D-L_x=200-L_y=200-L_z=200-10x10x10-Geometry_MSolve.inp";
                    string MatrixGonnectivityFileName = "MATRIX_3D-L_x=200-L_y=200-L_z=200-10x10x10-ConnMatr_MSolve.inp";
                    int matrixNodes = File.ReadLines(workingDirectory + '\\' + MatrixGeometryFileName).Count();
                    int matrixElements = File.ReadLines(workingDirectory + '\\' + MatrixGonnectivityFileName).Count();
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-3b\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 7000;
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-3c\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 7000;
            ...
            public static void EBEembeddedInMatrix_NewtonRaphson_Stochastic(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run3c-Stochastic-CNT-Results.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string outputFile = string.Format("{0}_{1}{2}", fileNameOnly, noStochasticSimulation, extension);
            ...
            public static class EBEEmbeddedModelBuilder
            {
                ...
                private static void HostElements(Model_v2 model)
                {
                    string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-3c\input files";
                    string MatrixGeometryFileName = "MATRIX_3D-L_x=200-L_y=200-L_z=200-10x10x10-Geometry_MSolve.inp";
                    string MatrixGonnectivityFileName = "MATRIX_3D-L_x=200-L_y=200-L_z=200-10x10x10-ConnMatr_MSolve.inp";
                    int matrixNodes = File.ReadLines(workingDirectory + '\\' + MatrixGeometryFileName).Count();
                    int matrixElements = File.ReadLines(workingDirectory + '\\' + MatrixGonnectivityFileName).Count();
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-3c\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 7000;
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-3d\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 7000;
            ...
            public static void EBEembeddedInMatrix_NewtonRaphson_Stochastic(int noStochasticSimulation)
            {
                ...
                // Request output
                string currentOutputFileName = "Run3d-Stochastic-CNT-Results.txt";
                string extension = Path.GetExtension(currentOutputFileName);
                string pathName = outputDirectory;
                string fileNameOnly = Path.Combine(pathName, Path.GetFileNameWithoutExtension(currentOutputFileName));
                string outputFile = string.Format("{0}_{1}{2}", fileNameOnly, noStochasticSimulation, extension);
            ...
            public static class EBEEmbeddedModelBuilder
            {
                ...
                private static void HostElements(Model_v2 model)
                {
                    string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-3d\input files";
                    string MatrixGeometryFileName = "MATRIX_3D-L_x=200-L_y=200-L_z=200-10x10x10-Geometry_MSolve.inp";
                    string MatrixGonnectivityFileName = "MATRIX_3D-L_x=200-L_y=200-L_z=200-10x10x10-ConnMatr_MSolve.inp";
                    int matrixNodes = File.ReadLines(workingDirectory + '\\' + MatrixGeometryFileName).Count();
                    int matrixElements = File.ReadLines(workingDirectory + '\\' + MatrixGonnectivityFileName).Count();
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-3d\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 7000;
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-4a\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            ...
            public static class EBEEmbeddedModelBuilder
            {
                ...
                private static void HostElements(Model_v2 model)
                {
                    string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-4a\input files";
                    string MatrixGeometryFileName = "MATRIX_3D-L_x=200-L_y=200-L_z=200-10x10x10-Geometry_MSolve.inp";
                    string MatrixGonnectivityFileName = "MATRIX_3D-L_x=200-L_y=200-L_z=200-10x10x10-ConnMatr_MSolve.inp";
                    int matrixNodes = File.ReadLines(workingDirectory + '\\' + MatrixGeometryFileName).Count();
                    int matrixElements = File.ReadLines(workingDirectory + '\\' + MatrixGonnectivityFileName).Count();
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-4a\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 12000;
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-4b\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 12000;
            ...
            public static class EBEEmbeddedModelBuilder
            {
                ...
                private static void HostElements(Model_v2 model)
                {
                    string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-4b\input files";
                    string MatrixGeometryFileName = "MATRIX_3D-L_x=200-L_y=200-L_z=200-10x10x10-Geometry_MSolve.inp";
                    string MatrixGonnectivityFileName = "MATRIX_3D-L_x=200-L_y=200-L_z=200-10x10x10-ConnMatr_MSolve.inp";
                    int matrixNodes = File.ReadLines(workingDirectory + '\\' + MatrixGeometryFileName).Count();
                    int matrixElements = File.ReadLines(workingDirectory + '\\' + MatrixGonnectivityFileName).Count();
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-4b\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 12000;
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-4c\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 12000;
            ...
            public static class EBEEmbeddedModelBuilder
            {
                ...
                private static void HostElements(Model_v2 model)
                {
                    string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-4c\input files";
                    string MatrixGeometryFileName = "MATRIX_3D-L_x=200-L_y=200-L_z=200-10x10x10-Geometry_MSolve.inp";
                    string MatrixGonnectivityFileName = "MATRIX_3D-L_x=200-L_y=200-L_z=200-10x10x10-ConnMatr_MSolve.inp";
                    int matrixNodes = File.ReadLines(workingDirectory + '\\' + MatrixGeometryFileName).Count();
                    int matrixElements = File.ReadLines(workingDirectory + '\\' + MatrixGonnectivityFileName).Count();
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-4c\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 12000;
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-4d\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 12000;
            ...
            public static class EBEEmbeddedModelBuilder
            {
                ...
                private static void HostElements(Model_v2 model)
                {
                    string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-4d\input files";
                    string MatrixGeometryFileName = "MATRIX_3D-L_x=200-L_y=200-L_z=200-10x10x10-Geometry_MSolve.inp";
                    string MatrixGonnectivityFileName = "MATRIX_3D-L_x=200-L_y=200-L_z=200-10x10x10-ConnMatr_MSolve.inp";
                    int matrixNodes = File.ReadLines(workingDirectory + '\\' + MatrixGeometryFileName).Count();
                    int matrixElements = File.ReadLines(workingDirectory + '\\' + MatrixGonnectivityFileName).Count();
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-4d\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 12000;
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-5a\output files\elastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            ...
            public static class EBEEmbeddedModelBuilder
            {
                ...
                private static void HostElements(Model_v2 model)
                {
                    string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-5a\input files";
                    string MatrixGeometryFileName = "MATRIX_3D-L_x=200-L_y=200-L_z=200-10x10x10-Geometry_MSolve.inp";
                    string MatrixGonnectivityFileName = "MATRIX_3D-L_x=200-L_y=200-L_z=200-10x10x10-ConnMatr_MSolve.inp";
                    int matrixNodes = File.ReadLines(workingDirectory + '\\' + MatrixGeometryFileName).Count();
                    int matrixElements = File.ReadLines(workingDirectory + '\\' + MatrixGonnectivityFileName).Count();
                ...
                private static void CohesiveBeamElements_Stochastic(Model_v2 model, int noStochasticSimulation)
                {
                    ...
                    double effectiveAreaY = area;
                    double effectiveAreaZ = area;
                    string workingDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-5\input files";
        ...
        {
            private const string outputDirectory = @"E:\GEORGE_DATA\DESKTOP\phd\EmbeddedExamples\Stochastic Embedded Example 4\run-5a\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 1000;
            private const int hostNodes = 1331;
            private const int embeddedElements = 25000;
