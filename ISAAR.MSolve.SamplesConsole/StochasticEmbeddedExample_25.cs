...
{
    public static class StochasticEmbeddedExample_25
    {
        //Run_2

        public static class Run2a_Elastic
        {
            private const string workingDirectory = @"C:\Users\cluster\source\repos\gsoim\Stochastic Embedded Example 25\run-2a\input files";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 25\run-2a\input files";
            //"C:\Users\cluster\source\repos\gsoim\Stochastic Embedded Example 25\run-2a\input files";
            private const string outputDirectory = @"C:\Users\cluster\source\repos\gsoim\Stochastic Embedded Example 25\run-2a\output files\elastic";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 25\run-2a\output files\elastic"; 
            //"C:\Users\cluster\source\repos\gsoim\Stochastic Embedded Example 25\run-2a\output files\elastic";
        ...
        public static class Run2a_Plastic
        {
            ...
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 25\run-2a\input files";
            //"C:\Users\cluster\source\repos\gsoim\Stochastic Embedded Example 25\run-2a\input files";
            private const string outputDirectory = @"C:\Users\cluster\source\repos\gsoim\Stochastic Embedded Example 25\run-2a\output files\plastic";
            //"D:\EmbeddedExamples\EmbeddedExamples\Stochastic Embedded Example 25\run-2a\output files\plastic"; 
            //"C:\Users\cluster\source\repos\gsoim\Stochastic Embedded Example 25\run-2a\output files\plastic";
            private const int subdomainID = 0;
            private const int hostElements = 5;
            private const int hostNodes = 24;
            private const int embeddedElements = 5;
