...
namespace ISAAR.MSolve.Tests.FEM
{
    public static class Hexa8NonLinearCantileverDefGrad
    {
        ...
        //         ElasticMaterial3D_v2DefGrad material1 = new ElasticMaterial3D_v2DefGrad() { PoissonRatio = 0.3, YoungModulus = 1353000 };
        ...
        //         // orismos elements 
        //         Element e1;
        //         int subdomainID = Hexa8NonLinearCantileverDefGrad.subdomainID;
    ...
    { 0,7.975944951878896600e-02 }, {11,-6.715222916021290600e-02 }, {23,-1.400036636464831200e-01 }, {35,-2.194844883932760600e-01 }, {47,-2.998045884933974200e-01 }};
        ...
        private static void BuildCantileverModel_v2(Model_v2 model, double load_value)
        {
            ...
            for (int nElement = 0; nElement < elementData.GetLength(0); nElement++)
            {
                ...
                {
                    ID = nElement + 1,
                    ElementType = new Hexa8NonLinearDefGrad_v2(material1, GaussLegendre3D.GetQuadrature(3, 3, 3)) // dixws to e. exoume sfalma enw sto beambuilding oxi//edw kaleitai me ena orisma to Hexa8                    
                };
                for (int j = 0; j < 8; j++)
                {
                    e1.NodesDictionary.Add(elementData[nElement, j + 1], model.NodesDictionary[elementData[nElement, j + 1]]);
