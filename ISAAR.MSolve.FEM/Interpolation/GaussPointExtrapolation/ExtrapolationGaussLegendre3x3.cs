...
namespace ISAAR.MSolve.FEM.Interpolation.GaussPointExtrapolation
{
    ...
    public class ExtrapolationGaussLegendre3x3 : GaussPointExtrapolation2DBase
    {
        ...
        private ExtrapolationGaussLegendre3x3() : base(GaussLegendre2D.GetQuadrature(3, 3))
        { }
        ...
        protected override double[] EvaluateExtrapolationFunctionsAt(NaturalPoint2D point)
        {
            ...
            // as the one defined by GaussLegendre2D.Order3x3, namely Xi major/Eta minor, instead of the usual Quad9 order.
