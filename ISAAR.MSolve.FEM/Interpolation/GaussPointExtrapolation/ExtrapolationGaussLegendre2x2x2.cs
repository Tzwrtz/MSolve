...
namespace ISAAR.MSolve.FEM.Interpolation.GaussPointExtrapolation
{
    ...
    public class ExtrapolationGaussLegendre2x2x2:GaussPointExtrapolation3DBase
    {
		...
		private ExtrapolationGaussLegendre2x2x2() : base(GaussLegendre3D.GetQuadrature(2, 2, 2)) { }
	    ...
	    protected override double[] EvaluateExtrapolationFunctionsAt(NaturalPoint3D naturalPoint)
	    {
