...
namespace ISAAR.MSolve.FEM.Elements
{
    ...
    public class CohesiveShell8ToHexa20_v2 : IStructuralFiniteElement_v2, IEmbeddedElement_v2
    {
        ...
        public IList<EmbeddedNode_v2> EmbeddedNodes => embeddedNodes;

        public IQuadrature2D QuadratureForStiffness { get; }
        
        private void GetInitialGeometricDataForMidsurface(IElement_v2 element)
        {
        ...
        private double[,] CalculateTMatrix(IElement_v2 element)
        {
            double[,] T;
            T = new double[24, 40];
        ...
        private double[] MultiplyForcesForEmbedding(double[] fxk1_coh, Element_v2 element)
        {
        ...
        private double[,] MultiplyStifnessMatrixForEmbedding(double [,] k_element_coh, IElement_v2 element)
        {
            double[,] T = CalculateTMatrix( element);
        ...
        public double[] GetLocalDOFValues(Element_v2 hostElement, double[] hostDOFValues) // omoiws Beam3D
        {
            ...
            //int multiplier = hostElement.ElementType.DofEnumerator_v2.GetDOFTypes(hostElement).SelectMany(d => d).Count();
            //int vectorIndex = 0;
