...
namespace ISAAR.MSolve.FEM.Elements
{
    ...
    public class ContinuumElement2DFactory
    {
        ...
        static ContinuumElement2DFactory()
        {
            ...
            integrationsForStiffness.Add(CellType2D.Quad4, GaussLegendre2D.GetQuadrature(2, 2));
            integrationsForMass.Add(CellType2D.Quad4, GaussLegendre2D.GetQuadrature(2, 2));
            ...
            integrationsForStiffness.Add(CellType2D.Quad8, GaussLegendre2D.GetQuadrature(3, 3));
            integrationsForMass.Add(CellType2D.Quad8, GaussLegendre2D.GetQuadrature(3, 3));
            ...
            integrationsForStiffness.Add(CellType2D.Quad9, GaussLegendre2D.GetQuadrature(3, 3));
            integrationsForMass.Add(CellType2D.Quad9, GaussLegendre2D.GetQuadrature(3, 3));
