...
namespace ISAAR.MSolve.FEM.Elements
{
    ...
    /// </summary>
    public class Hexa8NonLinear_v2 : IStructuralFiniteElement_v2, IEmbeddedHostElement_v2
    {
        ...
        public InterpolationHexa8Reverse_v2 Interpolation { get; }
        ...
        private void CalculateInitialConfigurationData(IElement_v2 element)
        {
            ...
            (Matrix[] J_0inv_hexa, double[] detJ_0) = JacobianHexa8Reverse_v2.GetJ_0invHexaAndDetJ_0(
        ...
        private void CalculateStrains(double[] localdisplacements, IElement_v2 element, double[][] tx_i) 
        {
            IReadOnlyList<Matrix> shapeFunctionNaturalDerivatives;
            shapeFunctionNaturalDerivatives = Interpolation.EvaluateNaturalGradientsAtGaussPoints(QuadratureForStiffness);
            (Matrix[] J_0inv_hexa, double[] detJ_0) = JacobianHexa8Reverse_v2.GetJ_0invHexaAndDetJ_0(
            ...
            Matrix[] J_1 = JacobianHexa8Reverse_v2.Get_J_1(nGaussPoints, tx_i, shapeFunctionNaturalDerivatives);
        ...
        public virtual IMatrix MassMatrix(IElement_v2 element)
        {
            throw new NotImplementedException();
        }

        public virtual IMatrix DampingMatrix(IElement_v2 element)
        {
            throw new NotImplementedException();
        }
        #endregion
        ...
        protected double[,] GetCoordinatesTranspose(IElement_v2 element)
        {
        ...
        private double[] GetNaturalCoordinates(IElement_v2 element, Node_v2 node)
        {
