...
{
    public class SupportiveCohesiveBeam3DCorotationalQuaternion_v2 : SupportiveCohesiveBeam3DCorotationalAbstract_v2
    {
         ...
         *            The beam section.
         */
        public SupportiveCohesiveBeam3DCorotationalQuaternion_v2(IList<Node_v2> nodes, IIsotropicContinuumMaterial3D_v2 material, double density, 
        ...
        public override void UpdateState(double[] incrementalNodeDisplacements)
        {
            ...
            var meanRotationQuaternion = Quaternion_v2.CreateFromIndividualParts(meanRotationScalarPart, meanRotationVectorPart);
        ...
        private void InitializeElementAxes()
        {
            ...
            currentRotationMatrix = RotationMatrix_v2.CalculateRotationMatrix(globalVectorX, elementAxis);
