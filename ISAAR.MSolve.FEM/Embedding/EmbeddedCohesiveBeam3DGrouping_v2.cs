...
{
    public class EmbeddedCohesiveBeam3DGrouping_v2
    {
        ...
        public EmbeddedCohesiveBeam3DGrouping_v2(Model_v2 model, IEnumerable<Element_v2> hostGroup, IEnumerable<Element_v2> embeddedGroup, bool hasEmbeddedRotations)
        {
            this.model = model;
        ...
        public EmbeddedCohesiveBeam3DGrouping_v2(Model_v2 model, IEnumerable<Element_v2> hostGroup, IEnumerable<Element_v2> embeddedGroup)
        ...
        private void UpdateNodesBelongingToEmbeddedElements()
        {
            ...
            foreach (var embeddedElement in embeddedGroup)
            {
                ...
                foreach (var node in embeddedElement.Nodes.Skip(2))
                {
